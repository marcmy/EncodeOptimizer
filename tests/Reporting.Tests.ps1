...
Describe 'optimizer reporting' {
    ...
    It 'captures source samples candidates metrics savings confidence warnings command alternatives and rationale' {
        ...
        $search = [pscustomobject]@{
            ...
            AllEvaluations=@(
                [pscustomobject]@{ Quality=18; Passed=$false; MeanVmaf=97.5; WorstSampleVmaf=96.7; P05Vmaf=94.8 },
                [pscustomobject]@{ Quality=16; Passed=$true; MeanVmaf=98.1; WorstSampleVmaf=97.4; P05Vmaf=95.5 }
            )
